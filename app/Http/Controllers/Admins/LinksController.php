...
class LinksController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $result = (new Links())->getListWithPaginate(collect([
            'where' => $where,
            'page' => $page,
        ]));
        // print_r($result);
        ...
        $data['categoryList'] = (new Categories())->getListByModule('links');
    ...
    public function add(Request $request)
    {
        if (null !== $request->input('_submit')) {
            ...
            $result = (new Links())->saveData(collect($input));
